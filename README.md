...
1. Clone the sanda-registration-client project (consumer)
...
1. Clone/open the sanda-registrations service (producer)
...
### Assignment 4: A backend consumer and a backend provider: Write the contracts in Spring Cloud Contract
#### Step 1(consumer/producer): Create the contracts on the producer side.

1. Clone the sanda-tournaments project (producer)
...
1. Open the sanda-registrations project (consumer)
...
5. Run your tests
6. When your tests are succesful, you should have a folder **/pacts** in the root folder of your project. If they are unsuccessful, you can find detailed information in the **/logs** folder
